...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		UpdateRestaurant func(childComplexity int, input models.UpdateRestaurantInput) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Category.dishes":
		if e.complexity.Category.Dishes == nil {
			break
		}

		return e.complexity.Category.Dishes(childComplexity), true
	...
	case "City.uf":
		if e.complexity.City.Uf == nil {
			break
		}

		return e.complexity.City.Uf(childComplexity), true
	...
	case "Mutation.updateRestaurant":
		...
		return e.complexity.Mutation.UpdateRestaurant(childComplexity, args["input"].(models.UpdateRestaurantInput)), true
...
func (ec *executionContext) field_Mutation_updateRestaurant_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 models.UpdateRestaurantInput
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNupdateRestaurantInput2easyfoodᚋpkgᚋgraphqlᚋmodelsᚐUpdateRestaurantInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Category_dishes(ctx context.Context, field graphql.CollectedField, obj *models.Category) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Category().Dishes(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _City_uf(ctx context.Context, field graphql.CollectedField, obj *models.City) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Mutation_updateRestaurant(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateRestaurant(rctx, args["input"].(models.UpdateRestaurantInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputcreateDishInput(ctx context.Context, obj interface{}) (models.CreateDishInput, error) {
	...
	for k, v := range asMap {
		...
		case "restaurantId":
			...
			it.RestaurantID, err = ec.unmarshalNInt2int(ctx, v)
			if err != nil {
				return it, err
			}
		case "categoryId":
...
func (ec *executionContext) unmarshalInputupdateRestaurantInput(ctx context.Context, obj interface{}) (models.UpdateRestaurantInput, error) {
	var it models.UpdateRestaurantInput
	var asMap = obj.(map[string]interface{})
...
func (ec *executionContext) _City(ctx context.Context, sel ast.SelectionSet, obj *models.City) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "uf":
			out.Values[i] = ec._City_uf(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) unmarshalNupdateRestaurantInput2easyfoodᚋpkgᚋgraphqlᚋmodelsᚐUpdateRestaurantInput(ctx context.Context, v interface{}) (models.UpdateRestaurantInput, error) {
